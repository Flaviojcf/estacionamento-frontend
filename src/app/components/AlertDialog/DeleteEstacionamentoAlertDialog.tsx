...
interface IDeleteEstacionamentoAlertDialog {
  handleDeleteEstacionamento: (estacionamentoId: string) => void
  estacionamentoId: string
}

export function DeleteEstacionamentoAlertDialog({
  handleDeleteEstacionamento,
  estacionamentoId,
}: IDeleteEstacionamentoAlertDialog) {
  function handleConfirmDelete(estacionamentoId: string) {
    handleDeleteEstacionamento(estacionamentoId)
  }
      ...
      <AlertDialog.Content className="fixed left-1/2 top-1/2 w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-md bg-[#202024] p-8 text-gray-900 shadow sm:w-[320px]">
        <div className="flex flex-col h-56 justify-between items-center text-center px-4 sm:px-0">
          ...
          <AlertDialog.Description className="text-white text-xl">
            ...
            estacionamento selecionado, deseja continuar?
          ...
          <div className="flex justify-between w-full">
            ...
            <AlertDialog.Action>
              <p
                ...
                onClick={() => handleConfirmDelete(estacionamentoId)}
              >
                Confirmar
              </p>
            </AlertDialog.Action>
